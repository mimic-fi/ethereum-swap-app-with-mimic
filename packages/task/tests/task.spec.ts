...
import { Context, runTask, Swap, GetPriceMock, ContractCallMock } from '@mimicprotocol/test-ts'
...
describe('Task', () => {
  ...
  const context: Context = {
    ...
    settlers: [{ address: randomEvmAddress(), chainId: 1 }, { address: randomEvmAddress(), chainId: 10 }],
    timestamp: Date.now(),
  }
